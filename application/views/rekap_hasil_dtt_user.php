            ...
            <tbody>
                ...
                foreach ($rekap as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td><?php echo anchor('user/rekap_hasil_bulanan_dtt?bulan='.$data->bulan.'&tahun='.$data->tahun.'&id='.$data->id_user,'<div class="font-weight-bold btn btn-primary btn-sm">LIHAT DATA</div>')?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
