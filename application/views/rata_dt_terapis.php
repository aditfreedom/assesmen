<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">PERHITUNGAN DT </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Monitoring</a></li>
                        <li class="breadcrumb-item active">Rata-Rata DT</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="container">
        ...
        <table class="table table-hover" id="example">
            ...
            <tbody>
                <?php $i = 1;
                foreach ($tampil_data_dt as $data) : ?>
        ...
        <form method="post" action="<?= base_url('admin/proses_hitung_dt'); ?>">
            <div class="row" hidden>
                ...
                <div class="col">
                    ...
                    <input type="number" name="data" class="form-control" value="<?=$tampil_jumlah_dt?>">
                    </div>               
                </div>
