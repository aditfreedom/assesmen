...
class User extends CI_Controller
{
	...
	public function rekap_penilaian()
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
		$this->load->view('rekap_penilaian_user');
		$this->load->view('template/footer');
	}
	...
	public function rekap_hasil_dt($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
		$this->load->view('rekap_hasil_dt_user',$data);
		$this->load->view('template/footer');
	}
	...
	public function rekap_hasil_bulanan_dt()
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
		$this->load->view('penilaian_dt_user_only',$data);
		$this->load->view('template/footer');
	}
	...
	public function rekap_dtt()
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
		$this->load->view('rekap_dtt_user',$data);
		$this->load->view('template/footer');
	}
	...
	public function rekap_hasil_dtt($id)
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
		$this->load->view('rekap_hasil_dtt_user',$data);
		$this->load->view('template/footer');
	}
	...
	public function rekap_hasil_bulanan_dtt()
	{
		...
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
		$this->load->view('penilaian_dtt_user_only',$data);
		$this->load->view('template/footer');
	}
	...
	{
		$sess_data = $this->session->userdata();
		$data['data_siswa'] = $this->M_assesmen->tampildatasiswa_biodata($id)->result();
		$this->load->view('template/header');
		$this->load->view('template/sidebar_user', $sess_data);
