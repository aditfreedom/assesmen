<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">REKAP BULANAN DT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <tbody>
                ...
                foreach ($rekap as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td><?php echo anchor('admin/rekap_hasil_bulanan_dt?bulan='.$data->bulan.'&tahun='.$data->tahun.'&id='.$data->id_user,'<div class="font-weight-bold btn btn-primary btn-sm">LIHAT DATA</div>')?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
