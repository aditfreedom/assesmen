<div class="content-wrapper">
    ...
    <div class="container">
            ...
            <div class="row">                
                <div class="col">
                <a class="btn btn-primary font-weight-bold" style="width:100%;" href="<?= base_url('home/rekap_dt'); ?>">REKAP PENILAIAN DT</a>
                </div>
                <div class="col">
                <a class="btn btn-danger font-weight-bold" style="width:100%;" href="<?= base_url('home/rekap_dtt'); ?>">REKAP PENILAIAN DTT</a>
                </div>
            </div>
