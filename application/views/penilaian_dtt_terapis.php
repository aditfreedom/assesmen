<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">TABEL PENILAIAN DTT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="container">
            <p align="left">
            <a href="<?= base_url('admin/tambah_dtt'); ?>" class="btn btn-success">
            ...
            <tbody>
                ...
                foreach ($penilaian_dtt as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td><?php echo anchor('admin/edit_dtt/'.$data->id,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>')?>
                        <?php echo anchor('admin/hapus_dtt/'.$data->id,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>')?></td>	
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
