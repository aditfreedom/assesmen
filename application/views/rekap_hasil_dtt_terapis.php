<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">REKAP BULANAN DTT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Monitoring</a></li>
                        <li class="breadcrumb-item active">Rekap DTT</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <tbody>
                ...
                foreach ($rekap as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td class="text-bold"><?php echo $data->rata; ?></td>
                        <td class="text-bold"><?php echo $data->kategori; ?></td>
                        <td><?php echo anchor('admin/rekap_hasil_bulanan_dtt?bulan='.$data->bulan.'&tahun='.$data->tahun.'&id='.$data->id_user,'<div class="font-weight-bold btn btn-primary btn-sm">LIHAT DATA</div>')?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
