 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><b>SISWA<br><?php echo $nama; ?></b></a>
        </div>
      </div>
      ...
      <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">      
          ...
          <li class="nav-item ">
            <a href="<?=base_url('user/biodata/').$id_user;?>" class="nav-link">
            ...
            <li class="nav-item">
                <a href="<?=base_url('user/rekap_penilaian/');?>" class="nav-link">
                  <i class="far fa fa-table nav-icon"></i>
                  <p>Rekap Penilaian</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?=base_url('user/grafik_hasil/').$id_user;?>" class="nav-link">
