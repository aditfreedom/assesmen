...
<link href="<?=base_url()?>assets/img/favicon.png" rel="icon">
  ...
  <title>SISTEM MONITORING ABA</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <p class="text-sm font-weight-bold font-italic">Aplikasi Monitoring Terapi Autisme Metode ABA Pada SLB Vokasional Muhammadiyah Bireuen</p>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->