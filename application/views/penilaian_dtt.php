<div class="content-wrapper">
    ...
    <div class="container">
            <p align="left">
            <a href="<?= base_url('home/tambah_dtt'); ?>" class="btn btn-success">
            ...
            <tbody>
                ...
                foreach ($penilaian_dtt as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td><?php echo anchor('home/edit_dtt/'.$data->id,'<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>')?>
                        <?php echo anchor('home/hapus_dtt/'.$data->id,'<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>')?></td>	
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
