            ...
            <tbody>
                ...
                foreach ($rekap as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td><?php echo anchor('user/tampil_grafik?bulan='.$data->bulan.'&tahun='.$data->tahun.'&id='.$data->id_user.'&nama='.$data->nama,'<div class="font-weight-bold btn btn-primary btn-sm">LIHAT GRAFIK</div>')?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
