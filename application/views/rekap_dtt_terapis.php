<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">REKAP PENILAIAN DTT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <tbody>
                ...
                foreach ($user as $data) : ?>
                    <tr class="nomor text-center">
                        ...
                        <td><?php echo anchor('admin/rekap_hasil_dtt/'.$data->id_user,'<div class="font-weight-bold btn btn-primary btn-sm">LIHAT DATA</div>')?></td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            </tbody>
