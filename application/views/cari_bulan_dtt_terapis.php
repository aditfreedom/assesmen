<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark font-weight-bold">PERHITUNGAN DATA DTT</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Monitoring</a></li>
                        <li class="breadcrumb-item active">Cari DTT</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <div class="container">
            ...
            <hr>
            <form method="get" action="<?php echo base_url('admin/cari_dtt'); ?>">

                <div class="row">
                <div class="col">
                         <div class="form-group">
                            <label for="">Nama Siswa</label>
                            <select class="form-control selectpicker" data-size="5" name="id_user" id="bulan" data-style="btn-primary" data-live-search="true">
                ...
                <div class="form-group">
                <button type="submit" class="btn text-bold btn-success form-control" style="height:40px;">CARI DATA</button>                    
                </div>
            </form>
        </div>
